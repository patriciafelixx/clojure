...
(defn testa-uso-de-pacientes []
  (let [guilherme {:id 15, :nome "Guilherme"}
    ...
    ;símbolo paciente sendo usado em vários lugares do programa com significados diferentes
...
(teste-simples 30)
;(teste-simples "guilherme") => (not (instance? java.lang.Long "guilherme"))

(s/defn imprime-relatorio-de-paciente
  [visitas, paciente :- Long]
  (println "Visitas do paciente" paciente "são" (get visitas paciente)))

; agora conseguimos o erro em tempo de *execução*, que diz que
; o valor passado como parametro nao condiz com o schema Long.
;(testa-uso-de-pacientes)
...
;prismatic/schema -> https://clojars.org/prismatic/schema